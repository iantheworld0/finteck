...
class BottomsheetDepense extends StatefulWidget {
  const BottomsheetDepense({super.key});
  ...
  static void show(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const BottomsheetDepense(),
    );
  }

  @override
  State<BottomsheetDepense> createState() => _BottomsheetDepenseState();
}

class _BottomsheetDepenseState extends State<BottomsheetDepense> {
